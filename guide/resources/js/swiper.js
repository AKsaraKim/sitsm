...
(function () {
    ...
    window.Swiper = function (container, params) {
        ...
        // Pagination_num  
        if (s.params.pagination_num) {
            s.paginationContainer_num = $(s.params.pagination_num);
        }
        ...
        /*=========================
          Pagination_num
          ===========================*/
        s.updatePagination_num = function () {
            if (!s.params.pagination_num) return;
                //var numIndex = s.snapIndex;
                var pageNumHTML = '';
                var numberOfTotalNum = s.params.loop ? Math.ceil((s.slides.length - s.loopedSlides * 2) / s.params.slidesPerGroup) : s.snapGrid.length;
                 // for (var i = 0; i < numberOfTotalNum; i++) {
                 //    if(s.snapIndex == i){
                        pageNumHTML += '<span class="paging_focus">' + (s.activeIndex+1) + '</span>';
                 //    }
                 // }
                pageNumHTML += '&nbsp;/&nbsp;' + numberOfTotalNum + '';
                s.paginationContainer_num.html(pageNumHTML);
                //s.bullets = s.paginationContainer.find('.' + s.params.bulletClass);
